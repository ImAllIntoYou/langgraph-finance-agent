...
class Agent:
    ...
    def execute(self):
        # Format the conversation history as a single text input
        prompt = "\n".join(self.messages) + "\nAssistant:"
...
# ----- Final solution - Automating AI Agent
# Create a loop to automate until agent returns an answer
...
# # New Scenario: Calculating Combined Mass of Earth and Jupiter and etc.
